...
ecaPDOFilter::ecaPDOFilter(wxWindow* parent,wxWindowID id,const wxPoint& pos,const wxSize& size)
{
	...
	SetClientSize(wxSize(450,432));
	Move(wxDefaultPosition);
	SetMinSize(wxSize(400,450));
	BoxSizer1 = new wxBoxSizer(wxVERTICAL);
	BoxSizer2 = new wxBoxSizer(wxHORIZONTAL);
	Button2 = new wxButton(this, ID_BUTTON2, _("No"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_BUTTON2"));
	BoxSizer2->Add(Button2, 1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
	Button3 = new wxButton(this, ID_BUTTON3, _("All"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_BUTTON3"));
	...
	BoxSizer1->Add(CheckListBox1, 7, wxALL|wxEXPAND, 5);
